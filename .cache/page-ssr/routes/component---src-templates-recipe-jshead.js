...
const PageHeader = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_headlessui_react__WEBPACK_IMPORTED_MODULE_4__.Disclosure, {
  ...
  url: _assets_RR_svg__WEBPACK_IMPORTED_MODULE_3__["default"],
  additionalClasses: ['block h-8 md:h-40 w-auto'],
  alt: "Logo"
}))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
const HeaderImageWithText = ({
  ...
  className: "px-10 py-5 md:p-20 flex flex-col items-start justify-end w-7/12 h-full absolute bg-gradient-to-r from-primary to-transparent z-10"
...
const RecipeTemplate = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_layout__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    recipes: recipes,
    headerText: "Next recipe to cook:"
  }));
};
